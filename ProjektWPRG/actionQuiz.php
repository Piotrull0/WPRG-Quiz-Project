...
<div class='row w-100' >
    <div class='container mt-5 col-3 border border-dark border-3 p-3' >
        <div class='row align-items-center text-center border-bottom border-3 py-3'>
            ...
            <h1 class='col-sm-6' > Manage categories </h1 >
        </div >
        <div class='mt-3 mb-3 text-center' >
            <a class='btn btn-primary mt-3' href = 'manageCategories.php' > Go to categories </a >
        </div >
    </div >
    <div class='container mt-5 col-3 border border-dark border-3 p-3' >
        <div class='row align-items-center text-center border-bottom border-3 py-3' >
        ...
        <div class='mt-3 mb-3 text-center' >
            <a class='btn btn-primary mt-3' href = 'chooseQuiz.php' > Go to quizzes </a >
        </div >
    </div >
</div >
";
